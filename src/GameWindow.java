...
public class GameWindow implements MouseHandler {
    ...
    public GameWindow() {
        ...
        playBackgroundMusic("/Backgroundmusic.wav"); // Start background music
    ...
    private void updateScoreBoard() {
        ...
        Picture picture = new Picture(1080, 420, "scoreboard.png");
        picture.draw();
    ...
    private void drawGrid() {
        ...
        Picture background = new Picture(PADDING, PADDING, "Background.jpg");
        background.draw();
        Picture titlex = new Picture(1100, 50, "x.png");
        Picture titleo = new Picture(1360, 50, "o.png");
        Picture title = new Picture(1160, 0, "Title.png");
        Picture exit = new Picture(1600, 20, "Exit.png");
        exit.draw();
        titlex.draw();
        titleo.draw();
        title.draw();
        gridPicture = new Picture(50 + PADDING, 20 + PADDING, "Grid.png");
    ...
    private void drawX(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "x.png");
        picture.draw();
    ...
    private void drawO(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "o.png");
        picture.draw();
        pictureList.add(picture); // Track the picture for later deletion
    }
    ...
    private void displayMessage(String messageType) {
        ...
        switch (messageType) {
            case "Player 1 wins!":
                messagePicture = new Picture(centerX - 485, centerY - 200, "Player1.png"); // Adjust coordinates and image path
                playMusic("/Player1wins.wav");
                break;
            case "Player 2 wins!":
                messagePicture = new Picture(centerX - 485, centerY - 200, "Player2.png"); // Adjust coordinates and image path
                playMusic("/Player2wins.wav");
                break;
            case "Draw!":
                messagePicture = new Picture(centerX - 500, centerY - 280, "Draw.png"); // Adjust coordinates and image path
                playMusic("/Draw.wav");
                break;
        }
